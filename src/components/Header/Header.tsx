                            ...
                            <a
                                ...
                                className={
                                    link.name === 'Contact'
                                        ...
                                        : `font-semibold text-xs transition-colors duration-300 hover:text-orange-500 ${
                    ...
                    <div className="py-4 space-y-3 bg-white/95 backdrop-blur-md rounded-lg mt-2 px-4 shadow-lg">
                        {navLinks.map((link) => (
                            <a
                                ...
                                className={
                                    link.name === 'Contact'
                                        ? "block py-2.5 px-4 text-center mt-2 mx-2 rounded-lg bg-orange-500 text-white font-semibold hover:bg-orange-600 transition-colors duration-300"
                                        : "block py-2 px-2 text-gray-900 font-semibold hover:text-orange-500 transition-colors duration-300"
                                }
                            >
                                {link.name}
                            </a>
