...
const Header = () => {
    ...
    return (
        ...
        >
            {/* Top Subheader - Hidden on very small screens, visible on md and up */}
            <div className={`hidden md:block border-b transition-colors duration-300 ${isScrolled ? 'border-gray-100' : 'border-white/10'}`}>
                <div className="max-w-7xl mx-auto px-4 md:px-12 lg:px-20 h-10 flex items-center justify-between text-[11px] font-medium tracking-wider uppercase">
                    <div className="flex items-center gap-6">
                        <a 
                            href="tel:0750537127" 
                            className={`flex items-center gap-2 transition-colors hover:text-yellow-500 ${isScrolled ? 'text-gray-600' : 'text-white/80'}`}
                        >
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a 
                            ...
                            className={`transition-colors hover:text-yellow-500 ${isScrolled ? 'text-gray-600' : 'text-white/80'}`}
                        >
                            <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 448 512"><path d="M448 209.91a210.06 210.06 0 0 1-122.77-39.25V349.38A162.55 162.55 0 1 1 185 188.31V278.2a74.62 74.62 0 1 0 52.23 71.18V0l88 0a121.18 121.18 0 0 0 1.86 22.17h0A122.18 122.18 0 0 0 381 102.39a121.43 121.43 0 0 0 67 20.14z"/></svg>
                        </a>
                    </div>
                </div>
            </div>
