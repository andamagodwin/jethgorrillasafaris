                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-4">
                        ...
                        <div className="flex gap-3">
                            ...
                            <a href="https://www.instagram.com/eyre_gorilla_adventures_ltd" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-gray-800 hover:bg-gray-700 rounded flex items-center justify-center transition-colors" aria-label="Instagram">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="https://wa.me/256750537127" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-gray-800 hover:bg-gray-700 rounded flex items-center justify-center transition-colors" aria-label="WhatsApp">
                                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a href="https://www.tiktok.com/@eyre.gorilla.adve?_r=1&_t=ZS-952avi7uknB" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-gray-800 hover:bg-gray-700 rounded flex items-center justify-center transition-colors" aria-label="TikTok">
