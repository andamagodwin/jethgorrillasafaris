            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-lg text-gray-600 mt-4 max-w-2xl mx-auto">
                        Ready to explore Uganda's wild beauty? Contact us today and let's plan your perfect safari experience.
                    </p>
                </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="rounded-2xl p-8">
                            ...
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">info@eyregorillaadventures.com</p>
                                    <p className="text-gray-600">bookings@eyregorillaadventures.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">P.O BOX 203725</p>
                                    <p className="text-gray-600">Kampala GPO, Uganda</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="rounded-2xl p-8">
                            ...
                            <div className="flex gap-4">
                                <a href="#" className="w-12 h-12 bg-gray-100 hover:bg-gradient-to-br hover:from-yellow-500 hover:to-red-600 rounded-lg flex items-center justify-center transition-all duration-300 group">
                        ...
                        {/* Business Hours */}
                        <div className="bg-gradient-to-br from-yellow-500 to-red-600 rounded-2xl p-8 text-white">
