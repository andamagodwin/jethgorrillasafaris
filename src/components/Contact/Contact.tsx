...
const Contact = () => {
    ...
    return (
        <section className="relative bg-gradient-to-b from-gray-50 to-white py-20 px-6 md:px-12 lg:px-20 z-10">
                        ...
                        <div className="bg-white rounded-2xl shadow-xl p-8">
                            ...
                            <div className="flex items-start gap-4 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">info@jethgorillasafaris.com</p>
                                    <p className="text-gray-600">bookings@jethgorillasafaris.com</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600">Plot 123, Safari Street</p>
                                </div>
                            </div>
                        </div>
